...
class SoilSchema(BaseModel):
    ...
    soil_ph: Literal["Strong acidic (3.5–4.4)", "Acidic (4.5-6.5)", "Neutral (6.6–7.3)", "Alkaline (7.4-9)", "Strongly alkaline: > 9.0"] = Field(description="a measure of the acidity or alkalinity of soil and is measured in pH units.",)
    pct_soil_moisture: float = Field(description="the water that is held in the spaces between soil particles.", ge=0, le=100,)
    # nutrients_proportion: Dict[str, float] = Field(..., title="Nutrients Proportion", description="Proportion of nutrients in the soil")
    soil_fertility : Literal["Low", "Medium", "High"] = Field(description="the ability of soil to provide essential nutrients to plants.",)
