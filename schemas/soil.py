...
class SoilSchema(BaseModel):
    ...
    soil_texture: Dict[str, float] = Field(..., title="Soil Texture", description="Relative proportions of different sizes of soil particles")
    ...
    soil_structure: Literal["Granular", "Platy", "Blocky", "Prismatic", "Columnar", "Massive"] = Field(...,title="Soil Structure", description="the arrangement of soil particles into aggregates.",)
